...
test('printer: tokenizer: jsx: jsx-element: nested', (t) => {
    t.print(fixture.jsxElementNested);
    t.end();
});

test('printer: tokenizer: jsx: jsx-element: nested: with attributes', (t) => {
    t.print(fixture.jsxElementNestedWithAttributes);
    t.end();
});

test('printer: tokenizer: jsx: jsx-element: inside object', (t) => {
    t.print(fixture.jsxElementInsideObject);
    t.end();
});
...
test('printer: tokenizer: jsx: nested: indent', (t) => {
    t.print(fixture.jsxNestedIndent);
    t.end();
});
...
test('printer: tokenizer: jsx: print: encodedQuote', (t) => {
    const source = fixture.jsxEscapedQuote;
    const ast = parse(source);
    const result = print(ast);
    
    t.equal(result, fixture.jsxEscapedQuoteFix);
    t.end();
});

test('printer: tokenizer: jsx: jsx-encoded-quote: simple', (t) => {
    t.print(fixture.jsxEscapedQuoteSimple);
    t.end();
});
...
test('printer: tokenizer: jsx: parenthesized', (t) => {
    const source = fixture.jsxParenthesized;
...
test('printer: tokenizer: jsx: jsx-element: inside call', (t) => {
    t.print(fixture.jsxInsideCall);
    t.end();
});
