...
const insideParentLike = createTypeChecker('path.parentPath', [
    'Program',
    'BlockStatement',
...
export const VariableDeclaration = {
    ...
    after(path, {maybe, store}) {
        ...
        if (isLast(path.parentPath) && !path.parentPath.isBlockStatement() || !insideParentLike(path) && !isParentTSModuleBlock(path))
            return false;
