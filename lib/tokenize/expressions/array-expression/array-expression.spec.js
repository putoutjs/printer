...
test('printer: tokenizer: array: inside call', (t) => {
    t.print(fixture.arrayInsideCall);
    t.end();
});

test('printer: tokenizer: array: inside call: filesystem', (t) => {
    const ast = parse(fixture.arrayInsideCallFilesystem);
    ...
    t.equal(result, fixture.arrayInsideCallFilesystemFix);
    t.end();
});

test('printer: tokenizer: array: long identifier', (t) => {
    t.print(fixture.arrayLongIdentifier);
    t.end();
});

test('printer: tokenizer: statement: ArrayExpression: long-identifier: maxElementLengthInOneLine', (t) => {
    const ast = parse(fixture.arrayLongIdentifierMaxElementLengthInOneLine);
    ...
    t.equal(result, fixture.arrayLongIdentifierMaxElementLengthInOneLine);
    t.end();
});

test('printer: tokenizer: statement: ArrayExpression: long-string-literal', (t) => {
    t.print(fixture.arrayLongStringLiteral);
    t.end();
});

test('printer: tokenizer: statement: ArrayExpression: string and object', (t) => {
    t.print(fixture.arrayStringAndObject);
    t.end();
});

test('printer: tokenizer: statement: ArrayExpression: identifier template', (t) => {
    t.print(fixture.arrayIdentifierTemplate);
    t.end();
});

test('printer: tokenizer: array-expression: tuple: string, object', (t) => {
    t.print(fixture.arrayExpressionTupleStringObject);
    t.end();
});

test('printer: tokenizer: array-expression: strings: inside call', (t) => {
    t.print(fixture.arrayStringsInsideCall);
    t.end();
});
...
test('printer: tokenizer: array-expression: long lines', (t) => {
    t.print(fixture.arrayLongLines);
    t.end();
});

test('printer: tokenizer: array-expression: nested: strings', (t) => {
    t.print(fixture.arrayNestedStrings);
    t.end();
});

test('printer: tokenizer: array-expression: tuple strings last object', (t) => {
