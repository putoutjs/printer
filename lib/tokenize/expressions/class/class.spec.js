...
test('printer: tokenizer: expressions: class: implements', (t) => {
    t.print(fixture.classImplements);
    t.end();
});

test('printer: tokenizer: expressions: class: decorator', (t) => {
    t.print(fixture.classDecorator);
    t.end();
});
