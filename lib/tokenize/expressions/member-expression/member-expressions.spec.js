...
test('printer: tokenizer: member-expression: chain: property', (t) => {
    t.print(fixture.memberExpressionChainProperty);
    t.end();
});
...
test('printer: tokenizer: member-expression: chain route', (t) => {
    t.print(fixture.memberExpressionChainRoute);
    t.end();
});

test('printer: tokenizer: member-expression: chain call', (t) => {
    t.print(fixture.memberExpressionChainCall);
    t.end();
});

test('printer: tokenizer: member-expression: chain call: property', (t) => {
    t.print(fixture.memberExpressionChainCallProperty);
    t.end();
});
...
test('printer: tokenizer: member-expression: transform: return', (t) => {
    const source = fixture.memberExpressionReturn;
    const ast = parse(source);
    ...
    const result = print(ast);
    const expected = fixture.memberExpressionReturnFix;
    
    t.equal(result, expected);
    t.end();
});

test('printer: tokenizer: member-expression: parens', (t) => {
    t.print(fixture.memberExpressionParens);
    t.end();
});
