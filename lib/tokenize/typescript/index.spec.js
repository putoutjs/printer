...
test('printer: tokenizer: typescript: ts-union-type: babel 8', (t) => {
    const ast = parse(fixture.tsUnionTypeBabel8, {
        isTS: true,
    });
    
    const {typeAnnotation} = ast.program.body[0].declarations[0].id.typeAnnotation.typeAnnotation.elementType;
    
    assign(typeAnnotation, {
        extra: {
            parenthesized: true,
        },
    });
    ...
    t.equal(result, fixture.tsUnionTypeBabel8Fix);
    t.end();
});
