...
test('printer: tokenizer: typescript: ts-interface-heritage', (t) => {
    t.print(fixture.tsInterfaceHeritage);
    t.end();
});
...
test('printer: tokenizer: typescript: ts-class-implements', (t) => {
    t.print(fixture.tsClassImplements);
    t.end();
});

test('printer: tokenizer: typescript: ts-expression-with-type-arguments', (t) => {
    const ast = parse(fixture.tsExpressionWithTypeArguments);
    const result = print(ast);
    
    t.equal(result, fixture.tsExpressionWithTypeArguments);
    t.end();
});
